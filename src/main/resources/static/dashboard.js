...
// Disables Prev on page 0 and Next when the current page came back short
// (fewer than PAGE_SIZE items) or empty, i.e. there is no further page to load.
// Falls back to res.totalPages / res.last from a Spring Page response if present.
